...
export declare const injectiveAminoConverters: {
    ...
    "/injective.exchange.v1beta1.MsgExec": {
        aminoType: string;
        toAmino: (message: import("./exchange/v1beta1/tx").MsgExec) => import("./exchange/v1beta1/tx").MsgExecAmino;
        fromAmino: (object: import("./exchange/v1beta1/tx").MsgExecAmino) => import("./exchange/v1beta1/tx").MsgExec;
    };
