...
const createRPCQueryClient = async ({ rpcEndpoint }) => {
    ...
    return {
        ...
        injective: {
            auction: {
                v1beta1: (await Promise.resolve().then(() => __importStar(require("./auction/v1beta1/query.rpc.Query")))).createRpcQueryExtension(client)
            },
            exchange: {
                v1beta1: (await Promise.resolve().then(() => __importStar(require("./exchange/v1beta1/query.rpc.Query")))).createRpcQueryExtension(client)
            },
            insurance: {
                v1beta1: (await Promise.resolve().then(() => __importStar(require("./insurance/v1beta1/query.rpc.Query")))).createRpcQueryExtension(client)
            },
            ocr: {
                v1beta1: (await Promise.resolve().then(() => __importStar(require("./ocr/v1beta1/query.rpc.Query")))).createRpcQueryExtension(client)
            },
            oracle: {
                v1beta1: (await Promise.resolve().then(() => __importStar(require("./oracle/v1beta1/query.rpc.Query")))).createRpcQueryExtension(client)
            },
            peggy: {
                v1: (await Promise.resolve().then(() => __importStar(require("./peggy/v1/query.rpc.Query")))).createRpcQueryExtension(client)
            },
            wasmx: {
                v1: (await Promise.resolve().then(() => __importStar(require("./wasmx/v1/query.rpc.Query")))).createRpcQueryExtension(client)
            }
        }
    };
};
