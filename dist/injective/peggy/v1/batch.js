...
exports.OutgoingTxBatch = {
    ...
    fromAmino(object) {
        ...
        message.transactions = object.transactions?.map(e => exports.OutgoingTransferTx.fromAmino(e)) || [];
...
exports.OutgoingTransferTx = {
    ...
    fromAmino(object) {
        ...
        if (object.erc20_token !== undefined && object.erc20_token !== null) {
            message.erc20Token = attestation_1.ERC20Token.fromAmino(object.erc20_token);
        }
        if (object.erc20_fee !== undefined && object.erc20_fee !== null) {
            message.erc20Fee = attestation_1.ERC20Token.fromAmino(object.erc20_fee);
        }
        return message;
    },
    toAmino(message) {
