    ...
    switch (content.typeUrl) {
        ...
        case "/osmosis.poolincentives.v1beta1.ReplacePoolIncentivesProposal":
            return {
                ...
                value: gov_2.ReplacePoolIncentivesProposal.toAmino(gov_2.ReplacePoolIncentivesProposal.decode(content.value, undefined))
            };
        case "/osmosis.poolincentives.v1beta1.UpdatePoolIncentivesProposal":
            return {
                type: "osmosis/UpdatePoolIncentivesProposal",
                value: gov_2.UpdatePoolIncentivesProposal.toAmino(gov_2.UpdatePoolIncentivesProposal.decode(content.value, undefined))
            };
        case "/osmosis.protorev.v1beta1.SetProtoRevEnabledProposal":
            return {
                type: "osmosis/protorev/set-proto-rev-enabled-proposal",
                value: gov_3.SetProtoRevEnabledProposal.toAmino(gov_3.SetProtoRevEnabledProposal.decode(content.value, undefined))
            };
        case "/osmosis.protorev.v1beta1.SetProtoRevAdminAccountProposal":
            return {
                type: "osmosis/protorev/set-proto-rev-admin-account-proposal",
                value: gov_3.SetProtoRevAdminAccountProposal.toAmino(gov_3.SetProtoRevAdminAccountProposal.decode(content.value, undefined))
            };
        case "/osmosis.superfluid.v1beta1.SetSuperfluidAssetsProposal":
            return {
                type: "osmosis/set-superfluid-assets-proposal",
                value: gov_4.SetSuperfluidAssetsProposal.toAmino(gov_4.SetSuperfluidAssetsProposal.decode(content.value, undefined))
            };
        case "/osmosis.superfluid.v1beta1.RemoveSuperfluidAssetsProposal":
            return {
                type: "osmosis/del-superfluid-assets-proposal",
                value: gov_4.RemoveSuperfluidAssetsProposal.toAmino(gov_4.RemoveSuperfluidAssetsProposal.decode(content.value, undefined))
            };
        case "/osmosis.superfluid.v1beta1.UpdateUnpoolWhiteListProposal":
            return {
                type: "osmosis/update-unpool-whitelist",
                value: gov_4.UpdateUnpoolWhiteListProposal.toAmino(gov_4.UpdateUnpoolWhiteListProposal.decode(content.value, undefined))
            };
        case "/osmosis.txfees.v1beta1.UpdateFeeTokenProposal":
            return {
                type: "osmosis/UpdateFeeTokenProposal",
                value: gov_5.UpdateFeeTokenProposal.toAmino(gov_5.UpdateFeeTokenProposal.decode(content.value, undefined))
            };
        default:
