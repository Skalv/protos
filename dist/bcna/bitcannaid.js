...
exports.Bitcannaid = {
    ...
    fromAminoMsg(object) {
        return exports.Bitcannaid.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.Bitcannaid.decode(message.value);
    },
    toProto(message) {
        return exports.Bitcannaid.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/BitCannaGlobal.bcna.bcna.Bitcannaid",
            value: exports.Bitcannaid.encode(message).finish()
        };
    }
};
