...
const createRPCQueryClient = async ({ rpcEndpoint }) => {
    ...
    return {
        ...
        publicawesome: {
            stargaze: {
                alloc: {
                    v1beta1: (await Promise.resolve().then(() => __importStar(require("../stargaze/alloc/v1beta1/query.rpc.Query")))).createRpcQueryExtension(client)
                },
                claim: {
                    v1beta1: (await Promise.resolve().then(() => __importStar(require("../stargaze/claim/v1beta1/query.rpc.Query")))).createRpcQueryExtension(client)
                }
            }
        }
    };
