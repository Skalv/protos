...
const createRPCMsgClient = async ({ rpc }) => ({
    ...
    publicawesome: {
        stargaze: {
            alloc: {
                v1beta1: new (await Promise.resolve().then(() => __importStar(require("../stargaze/alloc/v1beta1/tx.rpc.msg")))).MsgClientImpl(rpc)
            },
            claim: {
                v1beta1: new (await Promise.resolve().then(() => __importStar(require("../stargaze/claim/v1beta1/tx.rpc.msg")))).MsgClientImpl(rpc)
            }
        }
    }
});
