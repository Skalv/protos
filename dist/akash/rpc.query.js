...
const createRPCQueryClient = async ({ rpcEndpoint }) => {
    ...
    return {
        akash: {
            audit: {
                v1beta2: (await Promise.resolve().then(() => __importStar(require("./audit/v1beta2/query.rpc.Query")))).createRpcQueryExtension(client)
            },
            cert: {
                v1beta2: (await Promise.resolve().then(() => __importStar(require("./cert/v1beta2/query.rpc.Query")))).createRpcQueryExtension(client)
            },
            deployment: {
                v1beta1: (await Promise.resolve().then(() => __importStar(require("./deployment/v1beta1/query.rpc.Query")))).createRpcQueryExtension(client),
                v1beta2: (await Promise.resolve().then(() => __importStar(require("./deployment/v1beta2/query.rpc.Query")))).createRpcQueryExtension(client)
            },
            escrow: {
                v1beta1: (await Promise.resolve().then(() => __importStar(require("./escrow/v1beta1/query.rpc.Query")))).createRpcQueryExtension(client),
                v1beta2: (await Promise.resolve().then(() => __importStar(require("./escrow/v1beta2/query.rpc.Query")))).createRpcQueryExtension(client)
            },
            market: {
                v1beta2: (await Promise.resolve().then(() => __importStar(require("./market/v1beta2/query.rpc.Query")))).createRpcQueryExtension(client)
            },
            provider: {
                v1beta2: (await Promise.resolve().then(() => __importStar(require("./provider/v1beta2/query.rpc.Query")))).createRpcQueryExtension(client)
            }
        },
        cosmos: {
            auth: {
