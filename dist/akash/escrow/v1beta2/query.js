...
exports.QueryPaymentsResponse = {
    ...
    fromAmino(object) {
        const message = createBaseQueryPaymentsResponse();
        message.payments = object.payments?.map(e => types_1.FractionalPayment.fromAmino(e)) || [];
        if (object.pagination !== undefined && object.pagination !== null) {
            message.pagination = pagination_1.PageResponse.fromAmino(object.pagination);
        }
        return message;
    ...
    toAmino(message) {
        const obj = {};
        if (message.payments) {
            obj.payments = message.payments.map(e => e ? types_1.FractionalPayment.toAmino(e) : undefined);
        }
        else {
