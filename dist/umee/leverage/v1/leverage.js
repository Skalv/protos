...
exports.Token = exports.Params = void 0;
//@ts-nocheck
...
exports.Params = {
    ...
    encode(message, writer = binary_1.BinaryWriter.create()) {
        if (message.completeLiquidationThreshold !== "") {
            writer.uint32(18).string(math_1.Decimal.fromUserInput(message.completeLiquidationThreshold, 18).atomics);
        }
        if (message.minimumCloseFactor !== "") {
            writer.uint32(26).string(math_1.Decimal.fromUserInput(message.minimumCloseFactor, 18).atomics);
        }
        if (message.oracleRewardFactor !== "") {
            writer.uint32(34).string(math_1.Decimal.fromUserInput(message.oracleRewardFactor, 18).atomics);
        }
        if (message.smallLiquidationSize !== "") {
            writer.uint32(42).string(math_1.Decimal.fromUserInput(message.smallLiquidationSize, 18).atomics);
        }
        if (message.directLiquidationFee !== "") {
            writer.uint32(50).string(math_1.Decimal.fromUserInput(message.directLiquidationFee, 18).atomics);
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 2:
                    message.completeLiquidationThreshold = math_1.Decimal.fromAtomics(reader.string(), 18).toString();
                    break;
                case 3:
                    message.minimumCloseFactor = math_1.Decimal.fromAtomics(reader.string(), 18).toString();
                    break;
                case 4:
                    message.oracleRewardFactor = math_1.Decimal.fromAtomics(reader.string(), 18).toString();
                    break;
                case 5:
                    message.smallLiquidationSize = math_1.Decimal.fromAtomics(reader.string(), 18).toString();
                    break;
                case 6:
                    message.directLiquidationFee = math_1.Decimal.fromAtomics(reader.string(), 18).toString();
                    break;
                default:
...
exports.Token = {
    ...
    encode(message, writer = binary_1.BinaryWriter.create()) {
        ...
        if (message.reserveFactor !== "") {
            writer.uint32(18).string(math_1.Decimal.fromUserInput(message.reserveFactor, 18).atomics);
        }
        if (message.collateralWeight !== "") {
            writer.uint32(26).string(math_1.Decimal.fromUserInput(message.collateralWeight, 18).atomics);
        }
        if (message.liquidationThreshold !== "") {
            writer.uint32(34).string(math_1.Decimal.fromUserInput(message.liquidationThreshold, 18).atomics);
        }
        if (message.baseBorrowRate !== "") {
            writer.uint32(42).string(math_1.Decimal.fromUserInput(message.baseBorrowRate, 18).atomics);
        }
        if (message.kinkBorrowRate !== "") {
            writer.uint32(50).string(math_1.Decimal.fromUserInput(message.kinkBorrowRate, 18).atomics);
        }
        if (message.maxBorrowRate !== "") {
            writer.uint32(58).string(math_1.Decimal.fromUserInput(message.maxBorrowRate, 18).atomics);
        }
        if (message.kinkUtilization !== "") {
            writer.uint32(66).string(math_1.Decimal.fromUserInput(message.kinkUtilization, 18).atomics);
        }
        if (message.liquidationIncentive !== "") {
            writer.uint32(74).string(math_1.Decimal.fromUserInput(message.liquidationIncentive, 18).atomics);
        }
        ...
        if (message.maxCollateralShare !== "") {
            writer.uint32(122).string(math_1.Decimal.fromUserInput(message.maxCollateralShare, 18).atomics);
        }
        if (message.maxSupplyUtilization !== "") {
            writer.uint32(130).string(math_1.Decimal.fromUserInput(message.maxSupplyUtilization, 18).atomics);
        }
        if (message.minCollateralLiquidity !== "") {
            writer.uint32(138).string(math_1.Decimal.fromUserInput(message.minCollateralLiquidity, 18).atomics);
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    break;
                case 2:
                    message.reserveFactor = math_1.Decimal.fromAtomics(reader.string(), 18).toString();
                    break;
                case 3:
                    message.collateralWeight = math_1.Decimal.fromAtomics(reader.string(), 18).toString();
                    break;
                case 4:
                    message.liquidationThreshold = math_1.Decimal.fromAtomics(reader.string(), 18).toString();
                    break;
                case 5:
                    message.baseBorrowRate = math_1.Decimal.fromAtomics(reader.string(), 18).toString();
                    break;
                case 6:
                    message.kinkBorrowRate = math_1.Decimal.fromAtomics(reader.string(), 18).toString();
                    break;
                case 7:
                    message.maxBorrowRate = math_1.Decimal.fromAtomics(reader.string(), 18).toString();
                    break;
                case 8:
                    message.kinkUtilization = math_1.Decimal.fromAtomics(reader.string(), 18).toString();
                    break;
                case 9:
                    message.liquidationIncentive = math_1.Decimal.fromAtomics(reader.string(), 18).toString();
                    break;
                case 10:
                ...
                case 14:
                    ...
                    break;
                case 15:
                    message.maxCollateralShare = math_1.Decimal.fromAtomics(reader.string(), 18).toString();
                    break;
                case 16:
                    message.maxSupplyUtilization = math_1.Decimal.fromAtomics(reader.string(), 18).toString();
                    break;
                case 17:
                    message.minCollateralLiquidity = math_1.Decimal.fromAtomics(reader.string(), 18).toString();
                    break;
                case 18:
