...
exports.ExchangeRateTuple = exports.AggregateExchangeRateVote = exports.AggregateExchangeRatePrevote = exports.Denom = exports.Params = void 0;
//@ts-nocheck
...
exports.Params = {
    ...
    encode(message, writer = binary_1.BinaryWriter.create()) {
        ...
        if (message.voteThreshold !== "") {
            writer.uint32(18).string(math_1.Decimal.fromUserInput(message.voteThreshold, 18).atomics);
        }
        if (message.rewardBand !== "") {
            writer.uint32(26).string(math_1.Decimal.fromUserInput(message.rewardBand, 18).atomics);
        }
        ...
        if (message.slashFraction !== "") {
            writer.uint32(50).string(math_1.Decimal.fromUserInput(message.slashFraction, 18).atomics);
        }
        if (message.slashWindow !== BigInt(0)) {
            writer.uint32(56).uint64(message.slashWindow);
        }
        if (message.minValidPerWindow !== "") {
            writer.uint32(66).string(math_1.Decimal.fromUserInput(message.minValidPerWindow, 18).atomics);
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    break;
                case 2:
                    message.voteThreshold = math_1.Decimal.fromAtomics(reader.string(), 18).toString();
                    break;
                case 3:
                    message.rewardBand = math_1.Decimal.fromAtomics(reader.string(), 18).toString();
                    break;
                case 4:
                ...
                case 5:
                    ...
                    break;
                case 6:
                    message.slashFraction = math_1.Decimal.fromAtomics(reader.string(), 18).toString();
                    break;
                case 7:
                    message.slashWindow = reader.uint64();
                    break;
                case 8:
                    message.minValidPerWindow = math_1.Decimal.fromAtomics(reader.string(), 18).toString();
                    break;
                default:
    ...
    fromAmino(object) {
        ...
        message.acceptList = object.accept_list?.map(e => exports.Denom.fromAmino(e)) || [];
    ...
    toAmino(message) {
        ...
        if (message.acceptList) {
            obj.accept_list = message.acceptList.map(e => e ? exports.Denom.toAmino(e) : undefined);
        }
        else {
...
exports.AggregateExchangeRatePrevote = {
    ...
    fromAminoMsg(object) {
        return exports.AggregateExchangeRatePrevote.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.AggregateExchangeRatePrevote.decode(message.value);
    },
    toProto(message) {
        return exports.AggregateExchangeRatePrevote.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/umee.oracle.v1.AggregateExchangeRatePrevote",
            value: exports.AggregateExchangeRatePrevote.encode(message).finish()
        };
    }
};
...
exports.AggregateExchangeRateVote = {
    ...
    fromPartial(object) {
        const message = createBaseAggregateExchangeRateVote();
        message.exchangeRateTuples = object.exchangeRateTuples?.map(e => exports.ExchangeRateTuple.fromPartial(e)) || [];
        message.voter = object.voter ?? "";
        return message;
    },
    fromAmino(object) {
        const message = createBaseAggregateExchangeRateVote();
        message.exchangeRateTuples = object.exchange_rate_tuples?.map(e => exports.ExchangeRateTuple.fromAmino(e)) || [];
        if (object.voter !== undefined && object.voter !== null) {
            message.voter = object.voter;
        }
        return message;
    ...
    toAmino(message) {
        ...
        if (message.exchangeRateTuples) {
            obj.exchange_rate_tuples = message.exchangeRateTuples.map(e => e ? exports.ExchangeRateTuple.toAmino(e) : undefined);
        }
        else {
    ...
    fromAminoMsg(object) {
        return exports.AggregateExchangeRateVote.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.AggregateExchangeRateVote.decode(message.value);
    },
    toProto(message) {
        return exports.AggregateExchangeRateVote.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/umee.oracle.v1.AggregateExchangeRateVote",
            value: exports.AggregateExchangeRateVote.encode(message).finish()
        };
    }
};
...
exports.ExchangeRateTuple = {
    ...
    encode(message, writer = binary_1.BinaryWriter.create()) {
        ...
        if (message.exchangeRate !== "") {
            writer.uint32(18).string(math_1.Decimal.fromUserInput(message.exchangeRate, 18).atomics);
        }
        return writer;
    },
    decode(input, length) {
    ...
    fromAminoMsg(object) {
        return exports.ExchangeRateTuple.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.ExchangeRateTuple.decode(message.value);
    },
    toProto(message) {
        return exports.ExchangeRateTuple.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/umee.oracle.v1.ExchangeRateTuple",
            value: exports.ExchangeRateTuple.encode(message).finish()
        };
    }
};
