...
const createRPCMsgClient = async ({ rpc }) => ({
    ...
    umee: {
        leverage: {
            v1: new (await Promise.resolve().then(() => __importStar(require("./leverage/v1/tx.rpc.msg")))).MsgClientImpl(rpc)
        },
        oracle: {
            v1: new (await Promise.resolve().then(() => __importStar(require("./oracle/v1/tx.rpc.msg")))).MsgClientImpl(rpc)
        }
    }
});
