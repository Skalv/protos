...
const createRPCQueryClient = async ({ rpcEndpoint }) => {
    ...
    return {
        ...
        umee: {
            leverage: {
                v1: (await Promise.resolve().then(() => __importStar(require("./leverage/v1/query.rpc.Query")))).createRpcQueryExtension(client)
            },
            oracle: {
                v1: (await Promise.resolve().then(() => __importStar(require("./oracle/v1/query.rpc.Query")))).createRpcQueryExtension(client)
            }
        }
    };
};
