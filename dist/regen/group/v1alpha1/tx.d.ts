import { Member, MemberAmino, MemberSDKType, Choice, ThresholdDecisionPolicy, ThresholdDecisionPolicyProtoMsg, ThresholdDecisionPolicySDKType } from "./types";
...
export interface MsgCreateGroupAccount {
    ...
    decisionPolicy?: ThresholdDecisionPolicy | Any | undefined;
}
...
export type MsgCreateGroupAccountEncoded = Omit<MsgCreateGroupAccount, "decisionPolicy"> & {
    /** decision_policy specifies the group account's decision policy. */ decisionPolicy?: ThresholdDecisionPolicyProtoMsg | AnyProtoMsg | undefined;
};
/** MsgCreateGroupAccount is the Msg/CreateGroupAccount request type. */
...
export interface MsgCreateGroupAccountSDKType {
    ...
    group_id: bigint;
    metadata: Uint8Array;
    decision_policy?: ThresholdDecisionPolicySDKType | AnySDKType | undefined;
}
...
export type MsgUpdateGroupAccountDecisionPolicyEncoded = Omit<MsgUpdateGroupAccountDecisionPolicy, "decisionPolicy"> & {
    /** decision_policy is the updated group account decision policy. */ decisionPolicy?: ThresholdDecisionPolicyProtoMsg | AnyProtoMsg | undefined;
};
/**
 * MsgUpdateGroupAccountDecisionPolicy is the
 * Msg/UpdateGroupAccountDecisionPolicy request type.
...
export declare const DecisionPolicy_InterfaceDecoder: (input: BinaryReader | Uint8Array) => ThresholdDecisionPolicy | Any;
