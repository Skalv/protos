    ...
    return {
        ...
        regen: {
            data: {
                ...
                v1alpha2: (await Promise.resolve().then(() => __importStar(require("./data/v1alpha2/query.rpc.Query")))).createRpcQueryExtension(client)
            },
            ecocredit: {
                basket: {
            ...
            group: {
                v1alpha1: (await Promise.resolve().then(() => __importStar(require("./group/v1alpha1/query.rpc.Query")))).createRpcQueryExtension(client)
            }
        }
    };
};
