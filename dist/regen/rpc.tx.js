...
const createRPCMsgClient = async ({ rpc }) => ({
    ...
    regen: {
        data: {
            ...
            v1alpha2: new (await Promise.resolve().then(() => __importStar(require("./data/v1alpha2/tx.rpc.msg")))).MsgClientImpl(rpc)
        },
        ecocredit: {
            basket: {
        ...
        group: {
            v1alpha1: new (await Promise.resolve().then(() => __importStar(require("./group/v1alpha1/tx.rpc.msg")))).MsgClientImpl(rpc)
        }
    }
});
