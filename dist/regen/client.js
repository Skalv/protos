...
const regenDataV1alpha2TxRegistry = __importStar(require("./data/v1alpha2/tx.registry"));
...
const regenGroupV1alpha1TxRegistry = __importStar(require("./group/v1alpha1/tx.registry"));
const regenDataV1TxAmino = __importStar(require("./data/v1/tx.amino"));
const regenDataV1alpha2TxAmino = __importStar(require("./data/v1alpha2/tx.amino"));
...
const regenGroupV1alpha1TxAmino = __importStar(require("./group/v1alpha1/tx.amino"));
...
exports.regenProtoRegistry = [...regenDataV1TxRegistry.registry, ...regenDataV1alpha2TxRegistry.registry, ...regenEcocreditBasketV1TxRegistry.registry, ...regenEcocreditMarketplaceV1TxRegistry.registry, ...regenEcocreditV1TxRegistry.registry, ...regenEcocreditV1alpha1TxRegistry.registry, ...regenGroupV1alpha1TxRegistry.registry];
